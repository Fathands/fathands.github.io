...
layout:     post
title:      探索-vue转小程序
subtitle:   如何将单个vue文件转换为小程序所需的四个文件(wxml, wxss, json, js)
date:       2019-08-27
author:     Aiden
header-img: img/bg/post-bg-coffee.jpeg
catalog: true
tags:
    - vue
    - babel
...
![抽象语法树](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic1.jpg "抽象语法树")
...
![SFC](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic2.jpg "SFC")
...
比如需要把created方法转换为小程序的 onLoad 或者 组件中的 attached方法,
...
![script的基本结构](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic3.jpg "script的基本结构")
...
转换前的vue代码：
![转换前的vue代码](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic4.jpg "转换前的vue代码")

转换后的小程序代码：
![转换后的小程序代码](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic5.jpg "转换后的小程序代码")
...
解析出来的 AST树的结果如下：
![template AST树](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic6.jpg "template AST树")
...
转换前的vue代码：
![转换前的template代码](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic7.jpg "转换前的template代码")

转换后的小程序代码：
![转换后的小程序wxml代码](https://fathands.github.io/img/articles/ast-vue-mp/ast-pic8.jpg "转换后的小程序wxml代码")
